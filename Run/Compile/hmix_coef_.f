     ...
     &                    -v(i-1,j,k,nrhs)-v(i-1,j+1,k,nrhs)) )**2)
      ...
      if (.not.SOUTH_INTER .and. .not.WEST_INTER) then
        do k=1,N
          visc3d_r(Istr-1,Jstr-1,k)=0.5D0*
     ...
     &                           +visc3d_r(Istr-1,Jstr,k))
      ...
      if (.not.SOUTH_INTER .and. .not.EAST_INTER) then
        do k=1,N
          visc3d_r(Iend+1,Jstr-1,k)=0.5D0*
     ...
     &                          +visc3d_r(Iend+1,Jstr,k))
      ...
      if (.not.NORTH_INTER .and. .not.WEST_INTER) then
        do k=1,N
          visc3d_r(Istr-1,Jend+1,k)=0.5D0*
     ...
     &                           +visc3d_r(Istr-1,Jend,k))
      ...
      if (.not.NORTH_INTER .and. .not.EAST_INTER) then
        do k=1,N
          visc3d_r(Iend+1,Jend+1,k)=0.5D0*
